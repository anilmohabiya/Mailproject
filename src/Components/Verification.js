...
class Verification extends Component {
  ...
  <p className="text-white"><h1>Hey...</h1><br/>
            ...
            {/* <Card class="card text-white bg-success mb-3" style={{paddingLeft:50,paddingtop:50,height: 450 ,width :500}}>
             <img src={Logo2} style={{paddingLeft:40,height: 150 ,width :200}} />
             <Col><Card.Body >
              <p className="text-white"><h1>Hey...</h1><br/>
                <h3>if you are new here !!!</h3><br/>
                Sign up with your mobile number to get started
  ...
  <form>
              <div className="form-group">
                  ...
                  <input className="fas fa-user" type="email" className="form-control" placeholder="Enter Email/Mobile number" />
              </div>
              ...
              <button type="submit"  className="btn btn-warning btn-block" variant="light">Send OTP</button>
                
              <div id="otp-holder">
                <div id="otp-content">
                    <input id="otp-input" type="tel" maxlength="4" pattern="\d{4}" autocomplete="off"/>
                </div>
                </div>

              <button type="submit" className="btn btn-warning btn-block" variant="light">Verify</button>
